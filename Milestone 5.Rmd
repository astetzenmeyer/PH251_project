---
title: "Comparing Vaccination Rates to County Median Ages"
subtitle: "Do countys with low median ages have lower rates of vaccinations"
...
There is a growing concern that counties with younger median ages are less 
likely to have higher counts of vaccinated persons. To investigate this, we 
explored the California Census Demographics and California Vaccination Rates datasets to compare median age values and proportions of vaccinated persons
on a county level. By comparing the two, we can determine if there is any 
relationship between younger median ages and higher counts of vaccinated
...
### The data source for the COVID-19 Vaccine Administered by Zip Code dataset
###is the California Immunization Registry and the American Community Survey's
###2015-2019 5 Year Data. 
--first replaced missing data labeled as NA with the mean number of
total persons vaccinated for each count
--grouped data by county to derive the total vaccinated popluation for each
county
